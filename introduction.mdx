...
EmptyClassroom is a real-time classroom availability platform designed specifically for Boston University students. Find the perfect quiet space to study across campus by viewing live availability for 70+ classrooms in CAS and CGS buildings.
...
- **Classrooms:** 50+ rooms across multiple floors
...
- **Classrooms:** 20+ rooms optimized for smaller class sizes
